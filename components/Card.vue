<template>
    <div class="main-card mx-[100px] my-[115px] w-[1240px] h-[1010px] gap-[40px] flex flex-wrap">
            <div class="card-1-4 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-putih justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[221px] h-[38px] rounded-[7px] px-[7px] bg-color-green leading-[38.28px] text-3xl font-medium font-space">Search engine</h3>
            ...
            <div class="card-2-5 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-green justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[209px] h-[38px] rounded-[7px] px-[7px] bg-white leading-[38.28px] text-3xl font-medium font-space">Pay-per-click</h3>
            ...
            <div class="card-3-6 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-hitam justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[197px] h-[38px] rounded-[7px] px-[7px] bg-white leading-[38.28px] text-3xl font-medium font-space">Social Media</h3>
            ...
            <div class="card-1-4 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-putih justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[90px] h-[38px] rounded-[7px] px-[7px] bg-color-green leading-[38.28px] text-3xl font-medium font-space">Email</h3>
            ...
            <div class="card-2-5 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-green justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[133px] h-[38px] rounded-[7px] px-[7px] bg-white leading-[38.28px] text-3xl font-medium font-space">Content</h3>
            ...
            <div class="card-3-6 flex w-[600px] h-[310px] rounded-[45px] p-[50px] border-[1px] border-black shadow bg-color-hitam justify-between">
                <div class="Heading-link w-[221px] h-[210px] gap[93px]">
                    <div class="text-card mb-[93px]">
                        <h3 class="heading-3-1 w-[213px] h-[38px] rounded-[7px] px-[7px] bg-white leading-[38.28px] text-3xl font-medium font-space">Analytics and </h3>
